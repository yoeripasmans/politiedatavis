    ...
    function scroll(_this, d) {
		...
		if (window.pageYOffset >= 900) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 3));
                });
        }
		...
		if (window.pageYOffset >= 1200) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 4));
                });
        }
		...
		if (window.pageYOffset >= 1500) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 5));
                });
        }
		...
		if (window.pageYOffset >= 1800) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 6));
                });
        }
		...
		if (window.pageYOffset >= 2100) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 7));
                });
        }
		...
		if (window.pageYOffset >= 2400) {
            d3.select(_this)
                ...
                .ease(d3.easeCubicOut)
                .attr("r", function(d) {
					return circleSize(d.totaleSchendingen - (d.totaleSchendingen - 8));
                });
        }
